...
while True:
    if exists(Template(r"tpl1775529623551.png", record_pos=(-0.185, -0.196), resolution=(1334, 750))):
        ...
        break
# STAGE LEVEL 2
exists(Template(r"tpl1775530298499.png", record_pos=(-0.009, 0.142), resolution=(1334, 750)))
touch(Template(r"tpl1775530298499.png", record_pos=(-0.009, 0.142), resolution=(1334, 750)))
