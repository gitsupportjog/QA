...
while True:
    if exists(Template(r"tpl1775529623551.png", record_pos=(-0.185, -0.196), resolution=(1334, 750))):
        ...
        break
# STAGE LEVEL 5
exists(Template(r"tpl1775531417556.png", record_pos=(-0.146, 0.148), resolution=(1334, 750)))
touch(Template(r"tpl1775531417556.png", record_pos=(-0.146, 0.148), resolution=(1334, 750)))
...
sleep(1.0)
exists(Template(r"tpl1775537202299.png", record_pos=(0.107, 0.123), resolution=(1334, 750)))
touch(Template(r"tpl1775537202299.png", record_pos=(0.107, 0.123), resolution=(1334, 750)))
sleep(1.0)
exists(Template(r"tpl1775529723787.png", record_pos=(-0.001, 0.123), resolution=(1334, 750)))
touch(Template(r"tpl1775529723787.png", record_pos=(-0.001, 0.123), resolution=(1334, 750)))
sleep(10.0)
while True:
    ...
    if hand:
        ...
        break
sleep(3.0)
if exists(Template(r"tpl1775035986422.png", record_pos=(0.438, 0.212), resolution=(1334, 750))):
