...
while True:
    if exists(Template(r"tpl1775529623551.png", record_pos=(-0.185, -0.196), resolution=(1334, 750))):
        ...
        break
# STAGE LEVEL 3
exists(Template(r"tpl1775530711008.png", record_pos=(-0.001, 0.124), resolution=(1334, 750)))
touch(Template(r"tpl1775530711008.png", record_pos=(-0.001, 0.124), resolution=(1334, 750)))
wait(Template(r"tpl1775530779815.png", record_pos=(0.079, 0.123), resolution=(1334, 750)))
touch(Template(r"tpl1775530779815.png", record_pos=(0.079, 0.123), resolution=(1334, 750)))
sleep(1.0)
